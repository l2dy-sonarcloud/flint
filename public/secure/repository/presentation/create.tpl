...
<p>Please fill out the form below to create a new repository. If password is not set a random one will be created for you.</p>
...
<p>Please fill out the form below to clone an existing repository. If password is not set a random one will be created for you.</p>
...
<p>Please fill out the form below to upload an existing repository. Limit 8M in size. If your repository is larger than this, create a new empty project and push to it instead.</p>
